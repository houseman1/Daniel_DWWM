...
//Assign the parameter to the object 'obj_example_date'
    $obj_example_date = new DateTime($str_example_date);
...
//display the result
    echo "14/07/2019's week number is $str_week.";
    echo"<br>";
...
//Create a new instance of the class 'DateTime' as the object '$obj_end_date' with the parameter '$str_end_date'
    $obj_end_date = new DateTime($str_end_date);
...
//----------------------------------------------------------------------------------------------------------------------
// 4.  Reprenez l'exercice 3, mais traitez le problème avec les fonctions de gestion du timestamp,
// time() et mktime()
...
//Set the timezone of the object 'obj_datetime' to 'Europe/Paris'
    $obj_datetime->setTimeZone(new DateTimeZone('Europe/Paris'));
